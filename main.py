...
st.markdown(
    '<p class="subtitle" style="color:blue; font-weight:bold;">The app could take up to <b>20 seconds</b> when using for the first time due to API latency.</p>',
    unsafe_allow_html=True
)
