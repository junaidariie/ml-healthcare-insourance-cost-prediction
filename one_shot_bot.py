...
llm = ChatGroq(model="openai/gpt-oss-20b", api_key=os.getenv("GROQ_API_KEY"), streaming=False, temperature=0.4)
...
- Do NOT return markdown, bullet points, or special formatting.
- Use natural sentence breaks only (normal new lines).
